...
Tawspom maintains a playlist called **"My Active Music"** which serves as your primary listening source.
...
- **`python main.py refill`**: Process listened tracks and refill "My Active Music" to 12 hours.
